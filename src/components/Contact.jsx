...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_q51f3ci', // Replace with your EmailJS service ID
        'template_bz2p73e', // Replace with your EmailJS template ID
        {
          from_name: form.name,
          to_name: 'Kaushik M N', // Replace with your name
          from_email: form.email,
          to_email: 'krishna.kaushikmn@gmail.com', // Replace with your email
          message: form.message,
        },
        '67g0aF-5w7EgCsPYo' // Replace with your EmailJS public key
      )
      .then(
        () => {
          setLoading(false);
